...
/*
* @author Zeus
* create at 2019/4/8 11:33
* modify at 2019/4/8 11:33
* modify because 
* description: TO FIT
*/
...
class FerrisWheelView : View {
    ...
    private val coreStyleDefault: CoreStyle = CoreStyle(context.getColorRes(R.color.fwv_star_bg_color),
            baseColorDefault,
